...
const std::string svgHeader =   "<?xml version=\"1.0\" encoding=\"utf-8\"?>\n"
    ...
    " <defs>"
                   		"<linearGradient id=\"grad1\" gradientTransform=\"rotate(45)\" x1=\"0%\" y1=\"0%\" x2=\"100%\" y2=\"0%\">"
                              "<stop offset=\"0%\" style=\"stop-color:rgb(246,198,5);stop-opacity:1\" />"
                              "<stop offset=\"100%\" style=\"stop-color:rgb(246,139,0);stop-opacity:1\" />"
                              "</linearGradient>"

                        "<linearGradient id=\"grad2\" gradientTransform=\"rotate(45)\" x1=\"0%\" y1=\"0%\" x2=\"100%\" y2=\"0%\">"
                              "<stop offset=\"0%\" style=\"stop-color:rgb(246,139,0);stop-opacity:1\" />"
                              "<stop offset=\"100%\" style=\"stop-color:rgb(132,0,0);stop-opacity:1\" />"
                              "</linearGradient>"
"</defs>";
...
void Svgfile::addRect(double x1, double y1, double largeur, double hauteur, std::string color)
{
    m_ostrm << "<rect "
            << attrib("x", x1)
            << attrib("y", y1)

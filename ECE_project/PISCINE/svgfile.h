...
class Svgfile
{
    public:
        ...
        void adtextSVG(std::string texte);
        ...
        void addRect(double x1, double y1, double largeur, double hauteur, std::string color=defcol);
        void addRect2(double x1, double y1, double x2, double y2, std::string color=defcol);

        void addText(double x, double y, std::string text, std::string color=defcol);
        void addText(double x, double y, double val, std::string color=defcol);

        void addGrid(double span=100.0, bool numbering=true, std::string color=defcol);
